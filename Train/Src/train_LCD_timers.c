 ...
 ******************************************************************************
 */
#include <string.h> //because I want to use memset to initialize the handles to 0, strncpy and strncat
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
...
//Timers
BasicTimer_Handle_t timer7; //timer for I2C periodical reading (temperature sensor)
VirtualBasicTimer_t train_virtualTimer; //virtual timer simulating automatic train (linked to timer 7, with a shorter period)
